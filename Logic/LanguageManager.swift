...
class LanguageManager: ObservableObject {
    ...
    static let strings: [String: [AppLanguage: String]] = [
        ...
        "Intel Only Download Warning": [.english: "This download is an Intel-only build. On an Apple Silicon Mac it runs under Rosetta (slower), and macOS will ask you to install Rosetta. Homebrew above is recommended.", .japanese: "このダウンロードはIntel専用ビルドです。Apple SiliconのMacではRosetta経由での動作となり（低速）、macOSからRosettaのインストールを求められます。上のHomebrewでの導入を推奨します。"],
        "Rosetta Notice": [.english: "The FFmpeg in use is an Intel build and runs under Rosetta.", .japanese: "使用中のFFmpegはIntel版のため、Rosetta経由で動作しています。"],
        "Switch to Native": [.english: "Switch", .japanese: "切り替える"],
